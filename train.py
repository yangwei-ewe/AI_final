...
# 載入訓練圖片和標籤
for filename in os.listdir(train_img_folder)[:-10000]:
...
model = tf.keras.models.Sequential(
    [
        tf.keras.layers.Conv2D(
            32, (3, 3), activation="relu", input_shape=(100, 120, 1)
        ),
...
# 訓練模型
history = model.fit(train_images, train_labels_encoded, epochs=3, batch_size=32)
